function toc_sort_table(a) {
	...
	document.write('</table><div style="text-align:right;"><a href="http://kawansurabaya.blogspot.com" target="_blank" style="font:normal bold 10px/normal Arial,Sans-Serif;color:#666;text-shadow:0 1px 0 rgba(255,255,255,.2);" title="KS">Kawan Surabaya</a></div>');
}
